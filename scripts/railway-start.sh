...
export N8N_UNVERIFIED_PACKAGES_ENABLED="${N8N_UNVERIFIED_PACKAGES_ENABLED:-false}"
export N8N_VERIFIED_PACKAGES_ENABLED="${N8N_VERIFIED_PACKAGES_ENABLED:-false}"
...
echo "n8n starting on ${N8N_LISTEN_ADDRESS}:${N8N_PORT} (data: ${N8N_USER_FOLDER}, db: ${DB_TYPE:-sqlite}, community-packages: ${N8N_COMMUNITY_PACKAGES_ENABLED})"
